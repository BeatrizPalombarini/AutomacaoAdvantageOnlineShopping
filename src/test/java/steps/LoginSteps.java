...
public class LoginSteps{
    ...
    public void exibir_o_modal_login_cadastro() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o modal Login/Cadastro", loginpage.checkModalLoginCadastro());

    }

    @Então("deverá ser exibido o botão facebook")
    public void deverá_ser_exibido_o_botão_facebook() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o botão do facebook no modal de Login.", loginpage.checkBtnFacebook_NoModalLoginCadastro());

    }

    @Então("deverá ser exibido o input username no login")
    public void deverá_ser_exibido_o_input_username_no_login() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o input username no modal de Login.", loginpage.checkInputUsername_NoModalLoginCadastro());

    }

    @Então("deverá ser exibido o input password no login")
    public void deverá_ser_exibido_o_input_password_no_login() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o input password no modal de Login.", loginpage.checkInputPassword_NoModalLoginCadastro());

    }

    @Então("deverá ser exibido o botão remember me")
    public void deverá_ser_exibido_o_botão_remember_me() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o botão remember me no modal de Login.", loginpage.checkBtnRememberMe_NoModalLoginCadastro());
    ...
    public void deverá_ser_exibido_o_botão_sign_in() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o botão sign in no modal de Login.", loginpage.checkBtnSignIn_NoModalLoginCadastro());

    }

    @Então("deverá ser exibido o botão forgot your password?")
    public void deverá_ser_exibido_o_botão_forgot_your_password() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o botão forgot no modal de Login.", loginpage.checkBtnForgot_NoModalLoginCadastro());
    ...
    public void deverá_ser_exibido_o_botão_create_new_account() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o botão Create new account no modal de Login.", loginpage.checkBtnCreateNewAccount_NoModalLoginCadastro());
    ...
    public void não_deverá_entrar_na_conta() {
    	Assert.assertTrue("Houve um erro pois foi possivel se autenticar com dados invalidos.", loginpage.checkLoginInvalidoMSG());

    }
    @Então("não deverá conseguir clicar no botao sign in")
    public void não_deverá_conseguir_clicar_no_botao_sign_in() {
    	Assert.assertFalse("Houve um erro pois foi possivel clicar no botão mesmo com dados nulos.", loginpage.checkBtnLoginComDadosNulos());
    ...
    public void deverá_abrir_o_modal_de_login_do_facebook() {
    	Assert.assertTrue("Houve um erro ao tentar visualizar o modal facebook no Login.", loginpage.checkModalFacebook());
    ...
    public void deverá_ser_redirecionado_para_a_página_de_redefinição_de_senha() {
    	Assert.assertTrue("Houve um erro ao ser redirecionado para redefinição de senha.", loginpage.checkPageForgotPassword_ModalLogin());
