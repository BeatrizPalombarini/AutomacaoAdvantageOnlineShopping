...
public class CreateAccountSteps {
	...
	public void deverá_ser_redirecionado_para_a_página_de_criação_de_conta() {
		Assert.assertTrue("Houve um erro ao tentar visualizar a página de criação de conta.",
				createaccount.checkTxtCreateAccount());
	...
	public void deverá_ser_exibido_o_texto_account_details() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o texto account details.",
				createaccount.checkTxtAccountDetails());
	...
	public void deverá_ser_exibido_o_input_confirm_password() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o input confirm password.",
				createaccount.checkInputConfirmPassword());

	}

	@Então("deverá ser exibido o texto personal details")
	public void deverá_ser_exibido_o_texto_personal_details() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o texto personal details.",
				createaccount.checkTxtPersonalDetails());
	...
	public void deverá_ser_exibido_o_input_phone_number() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o input phone number.",
				createaccount.checkInputPhoneNumber());
	...
	public void deverá_ser_exibido_o_modal_de_opções_de_pais() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o input country.", createaccount.checkInputCountry());
	}
	...
	public void deverá_ser_exibido_o_input_postal_code() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o input postal code.",
				createaccount.checkInputPostalCode());
	...
	public void deverá_ser_exibido_o_botão_already_have_an_account() {
		Assert.assertTrue("Houve um erro ao tentar visualizar o botão already have an account?.",
				createaccount.checkBtnAlready());
	...
	public void deverá_cadastrar_uma_conta() {
		Assert.assertTrue("Houve um erro ao tentar cadastrar um novo usuário.", createaccount.checkCadastroSucesso());
	...
	public void não_deverá_cadastrar_uma_conta() {
		Assert.assertTrue("Houve um erro ao tentar cadastrar um novo usuário.", createaccount.checkCadastroFalha());
