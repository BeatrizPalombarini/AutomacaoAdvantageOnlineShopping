...
public class LoginPO extends Helper{
	...
	public void checkNomeNoLoginComoLogado() {
		...
		WebElement el = getDriver().findElement(By.xpath("//span[@class='hi-user containMiniTitle ng-binding' and contains(text(),'" + usernameValido + "')]"));
		waitForElement(el);
	...
	public boolean checkModalFacebook() {
		...
		//Caso depois de clicar no botão facebook ainda consiga ver o botão facebook, significa que não conseguimos visualizar o modal facebook.
	...
	public boolean checkPageForgotPassword_ModalLogin() {
		...
		// Caso depois de clicar forget password ainda consiga ver o botão  forget password, significa que não fomos redirecionados
